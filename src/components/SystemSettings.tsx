              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  ...
                  <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-sm text-blue-800">
                      <strong>Note:</strong> New users will receive a temporary password: <code>TempPassword123!</code>
                      <br />They should change this on their first login.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                      <h4 className="font-medium text-blue-900 mb-2">🔧 Technician</h4>
                      <ul className="text-sm text-blue-800 space-y-1">
                        <li>• Create/edit tickets</li>
                        <li>• Update ticket status</li>
                        <li>• Add customer notes</li>
                        <li>• Send customer emails</li>
                        <li>• Print labels</li>
                    ...
                    <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                      <h4 className="font-medium text-gray-900 mb-2">👁️ Viewer</h4>
                      <ul className="text-sm text-gray-800 space-y-1">
                        <li>• View tickets (read-only)</li>
                        <li>• View customer info</li>
                        <li>• Track customer devices</li>
                        <li>• View reports</li>
                        <li>• Print labels</li>
